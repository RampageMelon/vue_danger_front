<template>
  <div id="DangerManager">
      <div class="DangerManager_top">
      <el-col class="DangerManager_top" :span="24" >
        <div class="DangerManager_top_timu">法规文件：</div>
      </el-col>
     </div>  
     <el-table :data="tableData"style="width: 670px" id="DangerManager_middle" >
...
.DangerManager_top_timu{
  font-size: 30px;
  color: cornflowerblue;
}

.DangerManager_top_form{
  margin-top: 12px;
 
  margin-left: 10px;
}
#DangerManager_middle{
  margin-top: 10px;
}
