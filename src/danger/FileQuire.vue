<template>
  <div id="FileQuire">
      <div class="FileQuire_top">
      <el-col class="FileQuire_top" :span="24" >
        <div class="FileQuire_top_timu">法规文件：</div>
      </el-col>
     </div>  
     <el-table :data="tableData"style="width: 670px" id="FileQuire_middle" >
